...
var Step1 = (
  <div>
    <h1 className="header">Hello Copper js!</h1>
...
Copper.render(<Greeting message="Good day!" />, root);


class Alert extends Copper.Component {
  constructor(props) {
    super(props);
    this.state = {
      title: "Default title"
...
//Copper.render(<Alert message="Are you sure?" />, root);


class Stateful extends Copper.Component {
  constructor(props) {
    super(props);
    console.log(props);
  }
...
//Copper.render(<Stateful title="Task 1" />, root);


function update() {
  Copper.render(<Stateful title={new Date()} />, root);
}


class WishList extends Copper.Component {
  constructor(props) {
    super(props);
    this.state = {
      wish: {
...
class TodoItem extends Copper.Component {
  constructor(props) {
    super(props);
    this.logging = true;
  }
...
class TodoApp extends Copper.Component {
  constructor(props) {
    super(props);
